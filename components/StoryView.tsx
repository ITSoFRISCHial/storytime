...
export default function StoryView({ story, onNewStory }: StoryViewProps) {
  ...
  return (
    <div className="flex flex-col flex-1 px-6 py-6 gap-5 max-w-lg mx-auto w-full">
      {/* Image */}
      <div className="w-full aspect-[16/10] bg-gray-200 rounded-2xl overflow-hidden flex items-center justify-center relative">
        {story.imageUrl ? (
          <img
            src={story.imageUrl}
